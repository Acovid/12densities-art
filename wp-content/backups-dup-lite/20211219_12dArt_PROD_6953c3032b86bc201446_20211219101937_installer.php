...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20211219_12dArt_PROD_6953c3032b86bc201446_20211219101937_archive.zip';
	const ARCHIVE_SIZE		 = '262208616';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '6953c30-19101937';
    const SECONDARY_PACKAGE_HASH = '89f95a7-19101937';
	const VERSION			 = '1.4.3';
